                           ...
                           <input id="bidrfqCount" type="hidden" value="1" name="bidrfqCount">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="rfq_no" value="{{ $bidrfq->rfq_no}}"
                            ...
                            <div class="col-md-12 table-responsive" style="overflow-x:auto;">
                                <div class="form-group row">
                                    ...
                                    <table border="1" name="" id="mtable">
                                        <?php
                                        $arr=explode(",",$bidrfq->sample_size);
                                        $setup_cost=explode(",",$bidrfq->setup_cost);
                                        $recruitment = explode(",",$bidrfq->recruitment);
                                        $incentives = explode(",",$bidrfq->incentives);
                                        $moderation = explode(",",$bidrfq->moderation);
                                        $transcript = explode(",",$bidrfq->transcript);
                                        $others = explode(",",$bidrfq->others);
                                        // $country = explode(",",$bidrfq->country);
                                        $total_cost = explode(",",$bidrfq->total_cost);
                                        $client_id = explode(",",$bidrfq->client_id);
                                        $vendor_id = explode(",",$bidrfq->vendor_id);
                                        ?>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th>
                                                ...
                                                <select class="form-control label-gray-3" name="vendor_id_0[]">
                                                    <option class="label-gray-3" value="{{$value}}">Vendor</option>
                                                        @if(count($vendor) > 0)
                                                        @foreach($vendor as $v)
                                                    <option value="{{$v->vendor_name}}" {{$bidrfq && ($bidrfq->vendor_id == '$v->vendor_name') ? 'selected' : ''}} >{{$v->vendor_name}}</option>
                                                        @endforeach
                                                        @endif
                                                </select>
                                            </th>
                                            <th>
                                                <select class="form-control label-gray-3" name="client_id_0[]">
                                                    <option class="label-gray-3" value="{{$value}}">Client</option>
                                                        @if(count($client) > 0)
                                                        @foreach($client as $v)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="text" class="border-0" value="{{$value}}" {{$bidrfq && ($value == "$value" ) ? 'selected' : '' }} name="sample_size_0[]">
                                            <!-- {{$value}} -->
                                            </td> 
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Setup Cost</td>
                                            <td>Insert self</td>
                                            @foreach($setup_cost as $value)
                                                <td>
                                                <input type="text" class="border-0" value="{{$value}}" name="setup_cost_0[]">
                                                </td> 
                                            @endforeach
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="border-0" value="{{$value}}" name="recruitment_0[]">
                                            </td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="border-0" value="{{$value}}" name="incentives_0[]">
                                            </td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="border-0" value="{{$value}}" name="moderation_0[]"></td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Transcript</td>
                                            ...
                                            <td><input type="text" class="border-0" value="{{$value}}" name="transcript_0[]"></td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Others</td>
                                            ...
                                            <td><input type="text" class="border-0" value="{{$value}}" name="others_0[]"></td>
                                            @endforeach
                                        </tr>
                                        <tr>
                                            <td>Total Cost</td>
                                            <td>Insert Self</td>
                                            @foreach($total_cost as $value)
                                            <td><input type="text" class="border-0" value="{{$value}}" name="total_cost_0[]"></td>
                                            @endforeach
                                        </tr>
                                    </table><br>
                                    </div>
