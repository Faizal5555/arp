    ...
    @foreach($results as $research)
        <div class="card border-primary shadow-sm mb-4">
            <div class="card-body">
                            ...
                            @foreach($research->questions as $question)
                                <li class="mb-2">
                                    ...
                                    @if($question->attachment)
                                        <a href="{{ asset('adminapp/storage/app/public/' . $question->attachment) }}" class="text-decoration-none text-primary" target="_blank" download>  <i class="fas fa-paperclip px-1"></i>View Attachment</a>
                                    @endif
                                </li>
                            @endforeach
                        </ul>
                ...
                <!-- Team Members -->
                <div>
                    <h6 class="fw-semibold text-primary">Team Members:</h6>
                    <ul class="list-inline">
                        @foreach($research->teamMembers as $member)
                            <li class="list-inline-item badge bg-light text-dark border border-secondary me-1 mb-1">
