...
<!-- <script src="{{ asset('global_assets/js/demo_pages/fullcalendar_styling.js') }}"></script> -->
<!-- <script src="{{ asset('global_assets/js/plugins/fullcalendar/fullcalendar.min.js') }} "></script> -->
