    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border border-light">
                ...
                <div class="card-body">
                    <div class="row">
                        <form id="{{ $vendor && $vendor->id ? 'update' : 'register'}}" class="form col-md-12 d-flex flex-wrap"
                           enctype="multipart/form-data">
                           @csrf

                          
                           <input type="hidden" name="id" value="{{$vendor && $vendor->id ? $vendor->id : ''}}">
                            
                           <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor Name <span
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor Country<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <!-- <input name="vendor_country" value="{{$vendor && $vendor->vendor_country ? $vendor->vendor_country : ''}}" type="text"
                                            ...
                                            <select class="form-control label-gray-3" name="vendor_country">
                                                ...
                                                <option value="{{$v->name}}"   {{$vendor->vendor_country == $v->name ? 'selected' : ''}}> {{$v->name}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor Manager<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                            ...
                            <!--                    @if(count($client) > 0)-->
                            <!--                    @foreach($client as $v)-->
                            <!--                    <option value="{{$v->id}}" {{$vendor->client_id == $v->id ? 'selected' :   ''}}>{{$v->client_name}}</option>-->
                            <!--                    @endforeach-->
                            <!--                    @endif-->
                            <!--                </select>-->
                            <!--        </div>-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor Email<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input name="vendor_email"
                                            value="{{$vendor && $vendor->vendor_email ? $vendor->vendor_email : ''}}"
                                            type="text" class="form-control" placeholder="Vendor Email">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor Phone No<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input name="vendor_phoneno" value="{{$vendor && $vendor->vendor_phoneno ? $vendor->vendor_phoneno : ''}}"
                                            type="number" class="form-control" placeholder="Vendor Phone No">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold text-dark">Vendor WhatsApp<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input name="vendor_whatsapp" value="{{$vendor && $vendor->vendor_whatsapp ? $vendor->vendor_whatsapp : ''}}"
                                            type="number" class="form-control" placeholder="Vendor Whatsapp">
                                    </div>
                                </div>
                            </div>
