...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper" style="background-image: url('{{ asset('adminapp/assets/images/login_1.jpg') }}'); background-size: cover;">
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form method="POST" class="pt-3" action="{{ route('businessManager.login') }}">
                     @csrf
                                <!-- Validation Errors -->
