...
<script type="text/javascript">
             var start_date=moment(new Date()).format('Y-MM-DD');
            var end_date=moment(new Date()).format('Y-MM-DD');
    $(function(){
        $.ajaxSetup({
            headers: {
      ...
      var table = $('.data-table').DataTable({
          ...
          serverSide: true,
          ajax:{
              "url":"{{route('accounts.vendorpending')}}",
              'data':function(data){
          ...
          columns: [
            {data:'operation.project_no',name:'project_no'},
            {data:'operation.purchase_order_no',name:'purchase_order_no'},
            {data:'rfq',name:'rfq'},
                ...
                render: (data,type,row) => {
                        return `<div class="text-center">
                                    <div class="list-icons ">
                                        <a href='/accounts/pendingview/${row.id}'><i class="fas fa-eye"></i></a>
                                        </div>
                                    </div>`;
                        }},
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header header-elements-inline">
                    <a class="ml-2 card-title" style="color:#fff !important;">Vendor Invoice Pending</a>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-3">
                               ...
                               <input type="text" class="form-control" id="project_no" name="project_no" value="">
                            </div>
                            <div class="col-md-3">
                                <label>Po No</label>
                                {{-- <input type="po112" class="form-control" id="po_no" name="po_no" value="po111"> --}}
                                <input type="text" class="form-control" id="po_no" name="po_no" value="">
                            </div>
                            <div class="col-md-3">
