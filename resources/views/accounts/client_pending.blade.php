...
<script type="text/javascript">
    ...
    $(function(){
      ...
      var table = $('.data-table').DataTable({
          ...
          serverSide: true,
          ajax:{
              "url":"{{route('accounts.clientpending1')}}",
              'data':function(data){
                ...
                render: (data,type,row) => {
                        return `<div class="text-center">
                                    <div class="list-icons ">
                                        <a href='/adminapp/accounts/clientpendingview/${row.id}'><i class="fas fa-eye"></i></a>
                                        </div>
                                    </div>`;
                        }},
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header header-elements-inline">
                    <a class="ml-2 card-title" style="color:#fff !important;">Client Payment Pending</a>
                </div>
