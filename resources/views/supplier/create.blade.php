                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold ">Supplier Email <span
                                            class="text-danger"></span></label>
                                    <div class="col-lg-9">
                                        <input name="supplier_email" type="text" class="form-control" style="font-family: FontAwesome;" placeholder='&#xf199 Supplier Email' required pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,10}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
