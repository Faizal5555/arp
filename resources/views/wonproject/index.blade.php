...
{data: '', 
   ...
   $(document).on('change','#mode',function(){
    ...
    $('body').on('click', '.deletewon', function () {
     
     var wonproject_id = $(this).data("id");
     confirm("Are You sure want to delete !");
   
     $.ajax({
         type: "GET",
         url: ""+ '/adminapp/wonproject/'+'delete/'+wonproject_id,
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header header-elements-inline">
                    <a class="ml-2 card-title">Commissioned Project List</a>
