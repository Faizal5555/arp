                        ...
                        <form id="won" class="form col-md-12 d-flex flex-wrap update"
                           ...
                           <input id="bidrfqCount" type="hidden" value="1" name="wonCount">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input name="client_contract" style="text-transform: capitalize;" 
                                                id="otherField15" type="file"  value="{{$wonproject->client_contract ? $wonproject->client_contract :''}} " class="form-control p-1" placeholder="Attach Client Contract">
                                        </div>
                                    </div>
                                </div>
                                <?php 
                                        ...
                                        <div class="col-lg-9">
                                           ...
                                           <a target="_blank" download href="{{url($value4)}}">{{$value4}}</a>
                                            <input name="vendor_contract_0[{{$key}}]" style="text-transform: capitalize;" 
                                                id="otherField16" type="file" value="{{$value4}}" class="form-control p-1" placeholder="Attach Vendor Contract">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 d-flex align-items-center justify-content-center" id="won-rfq-btn">
                                 <p class="btn btn-primary mt-3" id="rfq-back">Back</p>
                                <button type="submit" id="addRegisterButton1"
                                    class="btn btn-success ml-2  won-sub">Update</button>
