...
$(document).on('click','.addvendor', function () { 
    ...
    var k = 1+parseInt($(this).closest('tbody').find('table .bidrfq-vendor:last-child').attr("data-id")); 
   
            if($('.sub-body_'+j+' tr').length!=0){
                for(i=0;i<2;i++){
                    $.each($('.sub-body_'+j+' tr'),function(index,value){
                        if(i==0){
                                $(value).append("<td class='bidrfq-vendor' id='col-vendor' data-id="+k+">"+$(value).find('td:nth-child(3)').html()+"</td>");
                               
                        }
                        })
                }  
                 $('.sub-body_'+j).find('.first-row td:last-child').append("<div class='removevendor'><i class='fa-solid fa-circle-minus'></i></div>"); 
             }
    ...
    $(document).on('keyup','td input:not(input[name^="sample_size"])', function () {
       // code logic here
        var id = $(this).parent().data('id');
           console.log($(this).closest('table').find('td:nth-child('+id+') input:not(input[name^="sample_size"])'));
        var sum = 0;
        $($(this).closest('table').find('td:nth-child('+id+') input:not(input[name^="sample_size"])')).each(function(i,v) {
            if($(this).val()!='' && i!=6){
                sum += Number($(this).val());
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input name="date"  value="{{ date('Y-m-d') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <select class="form-control label-gray-3" name="currency" id="currency">
                                                <option class="label-gray-3" value="" disabled selected>Select Currency</option>
                            ...
                            <div class="col-md-12 table-responsive" style="overflow-x:auto;">
                                <div class="form-group row">
                                    <label class="col-lg-12 col-form-label font-weight-semibold">Industry Table<span
                                            class="text-danger">*</span></label>
                                            <button class="btn btn-success  ml-2 addBtn" id="addBtn" attr="1" type="button" data-count="0">
                                                    Add Country
                                                </button>
                                    <div class="col-lg-12">
                                        <div class="rfq-table">
                                            ...
                                            <table class="table table-striped add-country" id="main-table" data-by="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <label class="form-group has-float-label">
                                                              <select class="form-control label-gray-3" name="country_0[0][]" required>
                                                               <option class="label-gray-3" value="">Country</option>
                                                            @if(count($country) > 0)
                                                             @foreach($country as $v)
                                                         <option value="{{$v->name}}">{{$v->name}}</option>
                                            ...
                                            <td></td>
                                            <td>
                                            <button class="btn btn-success  ml-2 float-left addvendor" data-vendor="0" data-count="0" type="button">
                                                    Add vendor
                                                </button>
                                            </td>
                                        ...
                                        <tbody class="sub-body_0">
                                         ...
                                         <!-- client/vendor name  -->
                                            ...
                                            <tr class="first-row">
                                               ...
                                               <td>
                                                   <select class="form-control label-gray-3" name="client_id_0[0][]" required>
                                                    <option class="label-gray-3" value="">Client</option>
                                                        @if(count($client) > 0)
                                                        @foreach($client as $v)
                                                    <option value="{{$v->client_name}}">{{$v->client_name}}</option>
                                               ...
                                               <td class="v">
                                                ...
                                                <select class="form-control label-gray-3" name="vendor_id_0[0][]" required>
                                                    <option class="label-gray-3" value="">Vendor</option>
                                                        @if(count($vendor) > 0)
                                                        @foreach($vendor as $v)
                                                    <option value="{{$v->vendor_name}}">{{$v->vendor_name}}</option>
                                            ...
                                            <td class="remove">
                                                ...
                                                <input  type="text" class='txtCal'  name="sample_size_0[0][]" placeholder="Sample Size">
                                                </div>
                                            </td>
                                            
                                            <td class="remove">
                                                
                                                <input type="text" class="txtbol" name="sample_size_0[0][]" placeholder="Sample Size">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td data-id="2"  class="bidrfq-client">
                                             ...
                                             <input type="text" class='txtCal' placeholder="Setup Cost" name="setup_cost_0[0][]">
                                                
                                            </td>
                                            
                                             <td class="bidrfq-vendor" data-id="3" ><input type="text" class="txtbol" placeholder="Setup Cost" name="setup_cost_0[0][]"></td>
                                            </tr>
                                        <tr>
                                            <td>Recruitment</td>
                                            ...
                                            <td data-id="2" class="bidrfq-client">
                                                ...
                                                <input type="text" class='txtCal' placeholder="Recruitment" name="recruitment_0[0][]">
                                                

                                            
                                            </td>
                                            <td class="bidrfq-vendor" data-id="3"><input type="text" class="txtbol" placeholder="Recruitment" name="recruitment_0[0][]"></td>
                                           </tr>
                                        <tr>
                                            <td>Incentives</td>
                                            ...
                                            <td data-id="2" class="bidrfq-client">
                                                ...
                                                <input type="text" class='txtCal' placeholder="Incentives" name="incentives_0[0][]">
                                            
                                            </td>

                                          <td class="bidrfq-vendor" data-id="3">
                                              <input type="text" class="txtbol" placeholder="Incentives" name="incentives_0[0][]"></td>
                                            </tr>
                                        <tr>
                                            <td>Moderation</td>
                                            ...
                                            <td data-id="2" class="bidrfq-client">
                                                    ...
                                                    <input type="text" class='txtCal' placeholder="Moderation" name="moderation_0[0][]">

                                               
                                            </td>
                                               
                                            <td class="bidrfq-vendor" data-id="3"><input type="text" class="txtbol" placeholder="Moderation" name="moderation_0[0][]"></td>
                                             </tr>
                                        <tr>
                                            <td>Transcript</td>
                                            ...
                                            <td data-id="2" class="bidrfq-client">
                                                    ...
                                                    <input type="text"class='txtCal' placeholder="Transcript" name="transcript_0[0][]">
                                                
                                                </td>
                                            <td class="bidrfq-vendor" data-id="3"><input type="text" class="txtbol" placeholder="Transcript" name="transcript_0[0][]"></td>
                                             </tr>
                                        <tr>
                                            <td>Others</td>
                                            
                                            <td data-id="2" class="bidrfq-client">
                                                <input type="text" class='txtCal' placeholder="Others" name="others_0[0][]">
                                                
                                                </td>
                                            <td class="bidrfq-vendor" data-id="3"><input type="text" class="txtbol" placeholder="Others" name="others_0[0][]"></td>
                                           </tr>
                                        <tr>
                                            <td>Total Cost</td>
                                            ...
                                            <td> <label class="my-currency"></label>
                                                <input type="text" class="total_cost border" placeholder="Total Cost" name="total_cost_0[0][]"></b></td>
                                           
                                            <td> <label class="my-currency"></label>
                                             <input type="text" class="total_cost border" placeholder="Total Cost" name="total_cost_0[0][]"></td>
                                        </tr>
