                ...
                <form class="row" id="form_id" autocomplete="off" enctype='multipart/form-data'>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="form-group row d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="email" name="email" id="email" class="form-control border border-secondary"  placeholder="Email Address"  style="width:100%;"  data-msg-email="Enter a valid email account!" pattern="[a-z0-9._]+@[a-z]+\.[a-z]{2,10}">
