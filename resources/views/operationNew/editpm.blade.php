                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input name="respondent_title"
                                            value="{{ $newrfq && $newrfq->respondent_title ? $newrfq->respondent_title : '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input name="interview_length"
                                            value="{{ $newrfq && $newrfq->interview_length ? $newrfq->interview_length : '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input name="others_field"
                                            value="{{ $newrfq && $newrfq->others_field ? $newrfq->others_field : '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        {{-- <input name="project_manager_name" value=""
                                             ...
                                             <input type="hidden" name="project_manager_name" value="{{ $operation->project_manager_name }}">
                                             <select class="form-control label-gray-3" name="project_manager_name"   {{ auth()->user()->user_role == "project_manager" ? 'disabled' : '' }}>
                                                @if(count($user1)>0)
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group row">
                                    <label class="col-lg-12 col-form-label font-weight-semibold">Target Table<span
                                            ...
                                            <button class="ml-2 btn btn-success" style="float: right; height: 40px;"id="AddTargetGroup"
