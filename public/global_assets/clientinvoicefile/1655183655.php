...
{{-- For date range picker --}}
 ...
 <div class="chart-title">
  <div class="container">
    <div class="row">
          <div class="col-md-3">
            <h4 class="card-title float-left">Team Leader Name</h4>
            <select class="form-control label-gray-3 sales" name="sales" id="sales" style="outline: 1px solid #89b3e2 !important;">
              <option class="label-gray-3" value="">Select Team Leader Name</option>
  ...
  <div class="col-md-12">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
         <div class="my-client" style="background-color: #0075f2 !important; padding: 10px; color: #ebedf2; margin-bottom: 12px; margin-top: 30px;">
          <h5>Total  Margin</h5>
         <h2> <label for="" class="total_margin"></label></h2>
        </div>
      </div>
        <div class="col-md-3">
          <div class="my-vendor" style="background-color: #b5ab31 !important;  padding: 10px; color: #ebedf2; margin-bottom: 12px; margin-top: 30px;">
         <h5 >Total Client Invoice</h5>
          <h2> <label for="" class="Total_client_invoice"></label></h2>
         </div>
        </div>
        <div class="col-md-3">
          <div class="my-total" style="background-color: #28a745 !important;  padding: 10px; color: #ebedf2; margin-bottom: 12px; margin-top: 30px;">
          <h5 >Total Vendor Invoice</h5>
          <h2> <label for="" class="Total_vendor_invoice"></label></h2>
        </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
         <div class="my-client" style="background-color: #0075f2 !important; padding: 10px; color: #ebedf2; margin-bottom: 12px; margin-top: 30px;">
          <h5>Rfq Followup</h5>
         <h2> <label for="" class="rfq_follow"></label></h2>
        </div>
      </div>
